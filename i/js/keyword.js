$(document).ready(function(){
    /*--------------------搜索框样式控制js------------------------*/
     var search_types={
        "types":[{name:"https://www.baidu.com/s?wd=",stype:"imgs/scbaidu.png",type:"baidu"},
                 {name:"https://www.sogou.com/web?query=",stype:"imgs/scsougou.png",type:"sogou"},
                 {name:"https://cn.bing.com/search?q=",stype:"imgs/scbing.png",type:"bing"},
                 {name:"https://www.so.com/s?q=",stype:"imgs/sc360.png",type:"so"},
                 {name:"https://www.google.com/search?q=",stype:"imgs/scgoogle.png",type:"google"},
                 {name:"http://www.cilimao.tv/search?word=",stype:"imgs/sccili.png",type:"cili"},
                 {name:"http://neets.cc/search?key=",stype:"imgs/scyingyin.png?v=1.1",type:"yingyin"},                 
                 /*--{name:"http://www.youhui.com/index.php?r=l&kw=",stype:"imgs/scyouhui.png",type:"youhui"}--*/
                ]};
    ...
    checktype.click(function(){        
        ...
        seach_type.animate({
            height:(type.height())*type.length,
                ...
                {
                    oMsoBtn1Img.src="imgs/msoBtn100.png";
                }
                else
                {
                    oMsoBtn1Img.src="imgs/msoBtn101.png";
                }
    });
